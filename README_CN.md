...
- llama-cpp-python >= 0.3.39（来自 https://github.com/JamePeng/llama-cpp-python，请根据你的硬件和 torch/cuda 版本安装合适的版本）
- Intel Arc GPU（SYCL）用户：安装后需删除 `llama_cpp/bin/`（参见上方 SYCL 环境注意事项）
